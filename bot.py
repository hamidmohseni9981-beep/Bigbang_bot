...
def get_main_markup():
    ...
    markup.add(
        telebot.types.InlineKeyboardButton("🧬 بانک تست زیست جامع - ۴۹۹,۰۰۰ تومان", callback_data="buy_zist"),
        telebot.types.InlineKeyboardButton("🧪 بانک تست شیمی جامع - ۴۴۹,۰۰۰ تومان", callback_data="shimi"),
        telebot.types.InlineKeyboardButton("💡 بانک تست فیزیک جامع - ۴۱۹,۰۰۰ تومان", callback_data="fizik"),
        telebot.types.InlineKeyboardButton("📐 بانک تست ریاضی جامع - ۴۴۹,۰۰۰ تومان", callback_data="math"),
        telebot.types.InlineKeyboardButton("📦 هر 4 بانک تست (پکیج کامل با تخفیف) - ۱,۵۰۰,۰۰۰ تومان", callback_data="full_4")
    )
    return markup
